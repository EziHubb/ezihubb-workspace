...
-- CreateEnum
CREATE TYPE "ABTestStatus" AS ENUM ('RUNNING', 'WINNER_A', 'WINNER_B', 'CANCELLED', 'INSUFFICIENT_DATA');
...
-- CreateEnum
CREATE TYPE "TrendDraftStatus" AS ENUM ('PENDING_REVIEW', 'APPROVED', 'REJECTED', 'EXPIRED', 'PENDING_GENERATION', 'GENERATING_BRIEF', 'GENERATING_IMAGE');

-- CreateEnum
CREATE TYPE "CreatorDNAStatus" AS ENUM ('PENDING', 'COMPLETED', 'FAILED', 'FETCHING_SOCIAL', 'ANALYZING');
...
CREATE TABLE "TrendProductDraft" (
    ...
    "expiresAt" TIMESTAMP(3) NOT NULL,
    "trendPlatform" TEXT NOT NULL DEFAULT 'tiktok',
    "trendDataSnapshot" JSONB,
    "ipScanStatus" TEXT NOT NULL DEFAULT 'PENDING',
