...
const FAQ_DATA: FaqItem[] = [
  ...
  },
  {
    ...
    answer: 'Absolutely. For orders of 10+ identical or similar items, contact us at bulk@maplehandmade.com for custom pricing and a dedicated account manager.',
  },
  ...
  },
  {
    ...
    answer: 'Take a photo of the damage or error and email it to support@maplehandmade.com within 7 days of delivery. We\'ll arrange a free replacement or full refund — whichever you prefer.',
  },
  {
      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8 py-10 md:py-14">
        ...
        <section className="mt-16 rounded-card border border-border bg-surface p-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            ...
            <a
              href="mailto:support@maplehandmade.com"
