        ...
        <div className="absolute right-0 top-full mt-2 z-50 bg-white border border-border rounded-2xl shadow-xl w-[300px] p-4 space-y-3">
          ...
          <div className="grid grid-cols-4 gap-2">
            ...
            <a
              ...
              className="flex flex-col items-center gap-1 p-2 rounded-xl border border-border hover:border-primary/30 hover:bg-muted/5 transition-colors"
            ...
            >
              ...
              <span className="text-[10px] text-muted">Facebook</span>
            </a>
            ...
            >
              ...
              <span className="text-[10px] text-muted">Pinterest</span>
            </a>
            ...
            >
              ...
              <span className="text-[10px] text-muted">X / Twitter</span>
            </a>
          </div>
