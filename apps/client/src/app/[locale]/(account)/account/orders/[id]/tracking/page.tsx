...
export default function OrderTrackingPage() {
  ...
  const { data: tracking, isLoading, isError } = useAuthQuery<TrackingDetail>(
    ['order-tracking', id],
    API_ROUTES.ORDER_TRACKING.DETAIL(id),
    undefined,
    { enabled: !!id },
  );

  // Build a lookup map from events for fast timestamp access
  ...
  // Stages to render — always show main stages; append FAILED_DELIVERY only if applicable
