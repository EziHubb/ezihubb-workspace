...
export const metadata: Metadata = {
  ...
  description: 'Join thousands of creators who share EziHubb products and earn every time their community shops.',
};
...
const STEPS = [
  { icon: Gift,       bg: 'bg-primary',   title: 'Get your creator link', body: 'Every EziHubb account comes with a unique link. No application needed.' },
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-muted text-base mt-5 max-w-md">
              Join thousands of creators who share EziHubb products and earn every time their community shops.
            </p>
