...
jest.mock('otplib', () => ({
  ...
  generateURI:    jest.fn(() => 'otpauth://totp/MapleLoom%20Admin:admin%40example.com?secret=JBSWY3DPEHPK3PXP&issuer=MapleLoom%20Admin'),
...
const mockTotpService = {
  ...
  otpAuthUri:         jest.fn().mockReturnValue('otpauth://totp/MapleLoom%20Admin:admin%40example.com?secret=JBSWY3DPEHPK3PXP&issuer=MapleLoom%20Admin'),
