    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.header}>
          <View>
            <Text style={styles.brandName}>MapleLoomHandmade</Text>
        ...
        <View style={{ flexDirection: 'row', marginBottom: 28, gap: 32 }}>
          ...
          <View style={{ flex: 1 }}>
            ...
            <Text style={styles.addressLine}>MapleLoomHandmade</Text>
            <Text style={styles.addressLine}>support@mapleloomhandmade.com</Text>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Thank you for your order!  Questions? support@mapleloomhandmade.com
          </Text>
