...
// Used by "Where valid" (Set up a sale) and any other seller-facing country
// picker. `code` is the ISO-2 code stored on the record; `''` means
// "everywhere" / no restriction and is handled separately by callers.
